...
#вычисляем b, количество "лент"( частей, на которые я делю вектор документа), для этого сначала определяем порог сходства(threshold)
threshold = 0.75
...
#на которые буду их делить и максимально возможный элемент (нужен для вычисления хэша)
