        ...
        if self.superstep % 2 == 0:
            ...
            if self.new_out_vertices:
                ...
                self.outgoing_messages = [(distant_vertex, self)
                                          ...
                                          for distant_vertex in vertex.new_out_vertices]
                self.out_vertices.extend(self.new_out_vertices)
                self.new_out_vertices[:] = []
        # In a second step vertex get edges to all of its distant vertices
        else:
            for _, new_distant_vertex in self.incoming_messages:
                new_distant_vertex.new_out_vertices.append(self)
